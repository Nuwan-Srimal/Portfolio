    ...
    <div className="home-page">
      ...
      <div className="hero-bg">
        ...
        <div className="kali-logo-container">
          <img 
            src="/logo.png" 
            alt="Nuwan Srimal Logo" 
            className="kali-logo-img" 
          />
        </div>
        ...
        <div className="hero-content">
          ...
          <div className="hero-btns">
            <Link to="/projects" className="btn-primary">
              <span style={{ color: '#fff' }}>View Projects</span>
          ...
          <div className="features-right">
            <div className="testimonial-card">
              <div className="test-header">
                <div className="test-avatar" style={{ fontSize: '1.2rem' }}>IZ</div>
                <div>
                  <h4>InnoZeta Solutions</h4>
                  <p>Our Tech Startup</p>
                </div>
              </div>
              <p className="test-quote" style={{ fontStyle: 'normal' }}>
                "Pioneering the future of digital solutions. At InnoZeta, we blend robust security practices with stunning web experiences to accelerate your business growth."
              </p>
              <div className="test-footer" style={{ marginTop: '1.5rem' }}>
                <a href="#" className="btn-primary" style={{ padding: '0.6rem 1.2rem', fontSize: '0.9rem', width: 'max-content' }}>Discover More</a>
              </div>
            </div>
          </div>
        </div>
